...
Build from interview answers. Use the template at `https://raw.githubusercontent.com/danparshall/claude_researcher/dddf518365f23f955bcf4b0e23ab1bccee31af65/template/templates/personal_info.md.template` as the structure; substitute each `<FIELD>` placeholder with the corresponding interview answer. The `<YYYY-MM-DD>` last-updated value is today's date.

#### `domain_allowlist.txt`

Fetch the content from `https://raw.githubusercontent.com/danparshall/claude_researcher/dddf518365f23f955bcf4b0e23ab1bccee31af65/template/templates/domain_allowlist.txt`. If the user named extra paper-source domains in Batch 3, add them to the paper-sources section before writing.
...
> `https://raw.githubusercontent.com/danparshall/claude_researcher/dddf518365f23f955bcf4b0e23ab1bccee31af65/template/_PROJECT_INSTRUCTIONS.md.template`
